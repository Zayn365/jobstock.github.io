 <!-- Download App Banner -->
 <?php
 if (empty($_SESSION) || $_SESSION['type'] != 1) { ?>
     <section class="download-app" style="background-image:url(assets/img/banner-7.jpg);">
         <div class="container">
             <div class="col-md-5 col-sm-5 hidden-xs"><img src="assets/img/iphone.png" alt="iphone" class="img-responsive" /></div>
         ...
         <div class="container">
             ...
             <div class="col-md-8 co-sm-8 pull-right">
                 <ul>
                     ...
                     <li><a href="viewjobs.php" title="">View Jobs</a></li>
                     <li><a href="login.php" title="">Login</a></li>
                     <li><a href="signup.php" title="">Register Now</a></li>
                 </ul>
             </div>
         </div>
     </div>
